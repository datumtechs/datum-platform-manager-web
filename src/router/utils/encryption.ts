// https://github.com/wukang0718/vueRouterEncryption/blob/master/utils/encryption.js
// 按需引入 CryptoJS 需要的组件
 ...
 * 加密 解密
 */
const baseCryptoCode = '1234567890000000' // 这个私钥每个项目指定一个唯一。更换密钥，请确认16位

const getKeyHex = (cryptoCode: string = baseCryptoCode) =>
  Latin1.parse(cryptoCode)
 ...
 * @returns {string}
 */
export const getEncrypt = (key: string, cryptoCode: string) => {
...
export const getEncryptToBase64 = (
  key: string,
  cryptoCode: string = baseCryptoCode,
) => {
 ...
 * @returns {string}
 */
export const getDecryptByBase64 = (data: any) => {
