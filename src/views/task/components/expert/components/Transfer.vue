<template>
  <div v-if="true" class="transfer mt-10px">
    <div class="columns-box">
      <p class="text-12px text-color-[#999999] leading-17px">Field</p>
    ...
    <div class="result">
      <p class="text-12px text-color-[#999999] leading-17px">ID column</p>
      ...
      <div class="feature">
        <p class="text-12px text-color-[#999999] leading-17px mt-10px mb-5px">Feature</p>
        <div
          class="features"
